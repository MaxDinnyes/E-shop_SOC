...
const telefony = document.getElementById('telefony');
const notebook = document.getElementById('notebook');
const hodinky = document.getElementById('hodinky');
const prislusenstvo = document.getElementById('prislusenstvo');
const widthProduktSelect = telefony.offsetHeight;

notebook.style.height = widthProduktSelect + 'px';
hodinky.style.height = widthProduktSelect + 'px';
prislusenstvo.style.height = widthProduktSelect + 'px';
console.log(widthProduktSelect);
